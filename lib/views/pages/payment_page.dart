                ...
                child: Column(
                  children: [
                    PaymentHeadLines(
                      title: 'Addres',
                      onTap: () {
                        Navigator.of(context).pushNamed(AppRoutes.locationPage).then((value) => cubit.getLocation(value as AddressChooseItemModel));
                        },
                    ),
                    const SizedBox(height: 8.0),
                    state.location==null? InkWell(
                      onTap: () {
                        Navigator.of(context).pushNamed(AppRoutes.locationPage).then((value) => cubit.getLocation(value as AddressChooseItemModel));
                      },
                      child: Container(
                    ...
                    ):SelectedLocationItem(item: state.location as AddressChooseItemModel),
